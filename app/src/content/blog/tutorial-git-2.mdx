...
Git en equipo consiste en coordinar historias: la tuya, la de `main`, la del remoto y la de otras personas. Las ramas aíslan trabajo, los remotos conectan repositorios, merge conserva contexto, rebase limpia historia y los conflictos obligan a decidir comportamiento. Cuando entiendes esas piezas, Git deja de ser una fuente de miedo y se convierte en una herramienta de colaboración real.
